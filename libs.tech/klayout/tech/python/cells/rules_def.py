...
DR['WN.S1'] = DRule(   7.0,  -1.0, 'WN','WN','Smin' )
DR['WN.S2'] = DRule(   9.5,  -1.0, 'WN(R)','WN','Smin' )
DR['WN.S3'] = DRule(  12.0,  -1.0, 'WN(C)','WN','Smin' )
...
DR['M1.SC'] = DRule(  10.0,  10.0, 'M1(C)','M1(C)','Smin/Smax' )
...
DR['V1.W1'] = DRule(   1.4,   1.4, 'V1','','Wfix' )
...
DR['M1.PO'] = DRule(   5.0,  -1.0, 'M1','PO','Fmin' )
DR['M2.PO'] = DRule(   5.0,  -1.0, 'M2','PO','Fmin' )
DR['M1.V1P'] = DRule(  10.0,  -1.0, 'M1','V1(P)','Fmin' )
DR['M2.V1P'] = DRule(  10.0,  -1.0, 'M2','V1(P)','Fmin' )
DR['M1P.AA'] = DRule(  14.0,  -1.0, 'M1(P)','AA','Smin' )
DR['M2P.AA'] = DRule(  14.0,  -1.0, 'M2(P)','AA','Smin' )
DR['M1P.GA'] = DRule(  14.0,  -1.0, 'M1(P)','GA','Smin' )
DR['M1P.GA'] = DRule(  14.0,  -1.0, 'M2(P)','GA','Smin' )
